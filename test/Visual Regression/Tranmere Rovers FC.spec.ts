// npx playwright test "test/Visual Regression/Tranmere Rovers FC.spec.ts" 
...
test.describe('Visual Regression Per Page', () => {
  const site = {
    ...
    preview: "https://livepreview.tranmererovers.co.uk",
    live: "https://www.tranmererovers.co.uk",
  };
  const pages = [
    { label: 'home', path: '/' },
