// npx playwright test "test/Visual Regression/Harrogate Town AFC.spec.ts"
...
test.describe('Visual Regression Per Page', () => {
  const site = {
    ...
    preview: "https://livepreview.harrogatetownafc.com",
    live: "https://www.harrogatetownafc.com",
  };
  const pages = [
    { label: 'home', path: '/' },
