// npx playwright test "test/Visual Regression/Barnsley FC.spec.ts"
...
test.describe('Visual Regression Per Page', () => {
  const site = {
    name: 'Barnsley FC.spec.ts',
    preview: "https://livepreview.barnsleyfc.co.uk",
    live: "https://www.barnsleyfc.co.uk",
  };
  const pages = [
    { label: 'home', path: '/' },
