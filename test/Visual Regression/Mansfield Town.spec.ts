// npx playwright test "test/Visual Regression/Mansfield Town.spec.ts"
...
test.describe('Visual Regression Per Page', () => {
  const site = {
    name: 'Mansfield Town.spec.ts',
    preview: "https://livepreview.mansfieldtown.net",
    live: "https://www.mansfieldtown.net",
  };
  const pages = [
    { label: 'home', path: '/' },
