// npx playwright test "test/Visual Regression/Oldham Athletic A.F.C.spec.ts" 
...
test.describe('Visual Regression Per Page', () => {
  const site = {
    ...
    preview: "https://livepreview.oldhamathletic.co.uk",
    live: "https://www.oldhamathletic.co.uk",
  };
  const pages = [
    { label: 'home', path: '/' },
