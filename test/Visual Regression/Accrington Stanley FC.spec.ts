// npx playwright test "test/Visual Regression/Accrington Stanley FC.spec.ts"
...
test.describe('Visual Regression Per Page', () => {
  const site = {
    ...
    preview: "https://livepreview.accringtonstanley.co.uk",
    live: "https://www.accringtonstanley.co.uk",
  };
  const pages = [
    { label: 'home', path: '/' },
