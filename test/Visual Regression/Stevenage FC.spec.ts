// npx playwright test "test/Visual Regression/Stevenage FC.spec.ts"
...
test.describe('Visual Regression Per Page', () => {
  const site = {
    name: 'Stevenage FC.spec.ts',
    preview: "https://livepreview.stevenagefc.com",
    live: "https://www.stevenagefc.com",
  };
  const pages = [
    { label: 'home', path: '/' },
