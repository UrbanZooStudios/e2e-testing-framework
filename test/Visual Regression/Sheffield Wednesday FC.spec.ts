// npx playwright test "test/Visual Regression/Sheffield Wednesday FC.spec.ts"
...
test.describe('Visual Regression Per Page', () => {
  const site = {
    name: 'Sheffield Wednesday FC.spec.ts',
    preview: "https://livepreview.swfc.co.uk",
    live: "https://www.swfc.co.uk",
  };
  const pages = [
    { label: 'home', path: '/' },
