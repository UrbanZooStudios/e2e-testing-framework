// npx playwright test "test/Visual Regression/Blackpool FC.spec.ts"
...
test.describe('Visual Regression Per Page', () => {
  const site = {
    name: 'Blackpool FC',
    preview: "https://livepreview.blackpoolfc.co.uk",
    live: "https://www.blackpoolfc.co.uk",
  };
  const pages = [
    { label: 'home', path: '/' },
    { label: 'news', path: '/news' },
    { label: 'matches', path: '/matches' },
    { label: 'teams', path: '/squads' },
  ];
