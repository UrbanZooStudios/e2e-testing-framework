// npx playwright test "test/Visual Regression/Preston North End.spec.ts"
...
test.describe('Visual Regression Per Page', () => {
  const site = {
    name: 'Preston North End.spec.ts',
    preview: "https://livepreview.pnefc.net",
    live: "https://www.pnefc.net",
  };
  const pages = [
    { label: 'home', path: '/' },
