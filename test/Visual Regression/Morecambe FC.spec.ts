// npx playwright test "test/Visual Regression/Morecambe FC.spec.ts"
...
test.describe('Visual Regression Per Page', () => {
  const site = {
    name: 'Morecambe FC.spec.ts',
    preview: "https://livepreview.morecambefc.com",
    live: "https://www.morecambefc.com",
  };
  const pages = [
    { label: 'home', path: '/' },
