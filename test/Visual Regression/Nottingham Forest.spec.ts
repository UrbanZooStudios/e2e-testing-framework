// npx playwright test "test/Visual Regression/Nottingham Forest.spec.ts"
...
test.describe('Visual Regression Per Page', () => {
  const site = {
    ...
    preview: 'https://livepreview.nottinghamforest.co.uk',
    live: 'https://www.nottinghamforest.co.uk',
  };
  const pages = [
    { label: 'home', path: '/' },
