...
await page.locator('[id="__nuxt"]').getByText('Automation').click();
...
// Click the first button in the button group (e.g., save or confirm)
await page.locator('.pt-4 > div > .flex > button').first().click();
