// npx playwright test "test/Visual Regression/Wycombe Wanderers.spec.ts"
...
test.describe('Visual Regression Per Page', () => {
  const site = {
    ...
    preview: "https://livepreview.gc.wycombewanderersfcservices.co.uk",
    live: "https://www.wwfc.com",
  };
  const pages = [
    { label: 'home', path: '/' },
