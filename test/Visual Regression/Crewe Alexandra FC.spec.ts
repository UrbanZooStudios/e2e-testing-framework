// npx playwright test "test/Visual Regression/Crewe Alexandra FC.spec.ts"
...
test.describe('Visual Regression Per Page', () => {
  const site = {
    name: 'Crewe Alexandra FC.spec.ts',
    preview: "https://livepreview.crewealex.net",
    live: "https://www.crewealex.net",
  };
  const pages = [
    { label: 'home', path: '/' },
