// npx playwright test "test/Visual Regression/Fulham FC.spec.ts"  
...
test.describe('Visual Regression Per Page', () => {
  const site = {
    name: 'Fulham FC',
    preview: "https://livepreview.fulhamfc.com",
    live: "https://www.fulhamfc.com",
  };

  const pages = [
    { label: 'home', path: '/' },
    //{ label: 'news', path: '/news/' }, Skipping this due to a time out when the test runs
