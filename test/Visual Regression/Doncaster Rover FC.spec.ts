// npx playwright test "test/Visual Regression/Doncaster Rover FC.spec.ts"
...
test.describe('Visual Regression Per Page', () => {
  const site = {
    ...
    preview: "https://livepreview.doncasterroversfc.co.uk",
    live: "https://www.doncasterroversfc.co.uk",
  };
  const pages = [
    { label: 'home', path: '/' },
