// npx playwright test "test/Visual Regression/Barrow AFC.spec.ts"
...
test.describe('Visual Regression Per Page', () => {
  const site = {
    name: 'Barrow AFC.spec.ts',
    preview: "https://livepreview.barrowafc.com",
    live: "https://www.barrowafc.com",
  };
  const pages = [
    { label: 'home', path: '/' },
